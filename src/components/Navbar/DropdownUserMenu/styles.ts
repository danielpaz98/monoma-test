...
export const Styles = {
	...
	MenuContainer: tw.div`absolute translate-x-1/2 right-3/4 top-12 z-10 divide-y rounded-lg border border-neutral-1/[0.35] w-44 p-2 bg-neutral-2 divide-gray-600`,
